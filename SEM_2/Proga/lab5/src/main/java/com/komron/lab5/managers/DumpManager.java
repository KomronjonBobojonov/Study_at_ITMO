...
public class DumpManager {
     ...
     */
    public Collection<Movie> readCollection() {
        System.out.println(fileName);
        if (fileName != null && !fileName.isEmpty()) {
            try (var fileReader = new FileReader(fileName)) {
                var collectionType = new TypeToken<PriorityQueue<Movie>>() {
                }.getType();
                ...
                PriorityQueue<Movie> collection = gson.fromJson(jsonString.toString(), collectionType);
                PriorityQueue<Movie> queue =  new PriorityQueue<>();

                (new ArrayList<>(collection)).forEach(Movie -> {
