...
public class RemoveLower extends Command {
    ...
    public boolean apply(String[] arguments) {
        try {
            ...
            console.println("* Создание нового Movie (remove_lower):");
            var product = (new MovieForm(console, collectionManager)).build();
            collectionManager.removeLowerPricedMovies(product);
            return true;
            ...
            console.printError("Поля Movie не валидны! Продукт не создан!");
